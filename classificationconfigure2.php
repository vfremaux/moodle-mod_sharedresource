...
/// Build page
	...
	if($classifarray[$classification]['restriction'] == ''){
		...
		$classtable = $DB->get_records_sql($classifarray[$classification]['restriction']);
	}
	...
	print $OUTPUT->help_icon('classificationupdate', 'sharedresource', get_string('classificationupdate', 'sharedresource'));
	echo '</legend><br/>';
	if($error != ''){
	...
	echo $OUTPUT->help_icon('selecttaxon', 'selecttaxon', "sharedresource");
	echo '</legend><br/>';
	echo '<center>';
