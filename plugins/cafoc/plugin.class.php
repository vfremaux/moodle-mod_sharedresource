...
class plugin_cafoc extends plugin_base {
    ...
    public $ALLSOURCES = array('cafoc', 'lom');
...
/*                '7' => 'list',    */
        ...
        */
        '1_9' => array(
            ...
            */
            'values' => ['Image', 'Vidéo', 'Lien internet', 'Document texte (Word, pdf…)',
                          'Présentation (PowerPoint, Google Slides…)',
                          'Tableur (Excel, Google Sheets…)',
                          'Fichier exécutable (.exe…)',
                          'Fichier compressé (.zip, .rar…)',
                          'Fichier de conception (SketchUp…)',
                           'Autres'],
            'checked' => array(
                'system_write'  => 1,
                'system_read'  => 1,
        ...
        */
        '5_2' => array(
            ...
            */
            'values' => ['Cours en intégralité', 'Travaux pratiques', 'Évaluations', 'Quiz', 'Documents interactifs',
                         'Vidéos interactives', 'Modélisations 3D', 'Ressources immersives pour la réalité virtuelle',
                          'Ressources immersives pour la réalité augmentée', 'Autres'],
            'checked' => array(
                'system_write'  => 1,
                'system_read'  => 1,
                'indexer_write' => 0,
    ...
    /**
     * format must expose the values, so a function to find the format field is usefull
     */
    ...
    /**
     * size must expose the values, so a function to find the size field is usefull
     */
