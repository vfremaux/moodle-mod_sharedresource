...
class plugin_scolomfr extends plugin_base {
    ...
    public $OTHERSOURCES = array(
        ...
        'méthodologie', 'outil', 'scénario pédagogique', 'enseignement primaire', 'enseignement secondaire', 'licence',
        ...
        'ScoLOMFRv2' => array('agrégateur de contenu', 'aide technique', 'appareil photographique', 'baladeur',
            ...
            'logiciel d\'animation', 'logiciel d\'application', 'logiciel de bureautique', 'logiciel de communication et d\'échange',
            'logiciel de création multimédia', 'logiciel de dessin assisté par ordinateur', 'logiciel de développement d\'application',
            'logiciel de fabrication assistée par ordinateur', 'logiciel de géométrie dynamique', 'logiciel de gestion de contenu',
            'logiciel de gestion de projet', 'logiciel de lecture de livre numérique', 'logiciel de manipulation d\'images et de vidéos',
            'logiciel de messagerie', 'logiciel de montage vidéo', 'logiciel de présentation assistée par ordinateur',
            'logiciel de programmation', 'logiciel de publication assistée par ordinateur', 'logiciel de publication en ligne',
            'logiciel de reconnaissance et de synthèse vocales', 'logiciel de reconnaissance vocale', 'logiciel de simulation',
            'logiciel de synthèse vocale', 'logiciel de traitement de son', 'logiciel de traitement de tableaux et calculs',
            'logiciel de traitement de texte', 'logiciel de traitement d\'enquête', 'logiciel de traitement d\'image fixe',
            'logiciel de traitement vidéo', 'logiciel de travail collaboratif', 'logiciel de visualisation et de lecture de média',
            'logiciel d\'édition et de gestion d\'exercices', 'logiciel d\'édition web', 'logiciel d\'enseignement',
            'logiciel d\'image de synthèse', 'logiciel documentaire', 'logiciel éditeur de texte', 'logiciel organiseur d\'idées',
            'logiciel ou application de lecture', 'logiciel reconnu d\'intérêt pédagogique', 'logiciel système',
            'logiciels', 'machine-outil à commande numérique', 'matériel', 'microphone', 'microscope', 'moteur de recherche',
...
'schéma/graphique', 'site web', 'tableau (art)', 'web média'),
        ...
        '5_14' => array(
            ...
            'values' => array(
                ...
                'en salle de classe',
                'en établissement',
                'espace dédié à une pratique spécifique',
                'en établissement socioculturel',
                'en bibliothèque médiathèque',
                'en mobilité',
                'en musée',
                'hors établissement',
                'en installation de loisirs',
                'en installation sportive',
                'en laboratoire',
        ...
        '5_16' => array(
            ...
            'values' => array(
                ...
                'liseuse',
                'logiciel d\'aide à l\'orientation',
                'logiciel d\'animation',
                'logiciel d\'application',
                'logiciel de bureautique',
                'logiciel de communication et d\'échange',
                ...
                'logiciel de lecture de livre numérique',
                'logiciel de manipulation d\'images et de vidéos',
                'logiciel de messagerie',
                'logiciel de montage vidéo',
                'logiciel de présentation assistée par ordinateur',
                'logiciel de programmation',
                'logiciel de publication assistée par ordinateur',
                'logiciel de publication en ligne',
                'logiciel de reconnaissance et de synthèse vocales',
                'logiciel de reconnaissance vocale',
                'logiciel de simulation',
                'logiciel de synthèse vocale',
                'logiciel de traitement de son',
                'logiciel de traitement de tableaux et calculs',
                ...
                'logiciel de visualisation et de lecture de média',
                'logiciel d\'édition et de gestion d\'exercices',
                'logiciel d\'édition web',
                'logiciel d\'enseignement',
                'logiciel d\'image de synthèse',
                'logiciel documentaire',
                'logiciel éditeur de texte',
                'logiciel organiseur d\'idées',
                'logiciel ou application de lecture',
                'logiciel reconnu d\'intérêt pédagogique',
                'logiciel système',
                'logiciels',
