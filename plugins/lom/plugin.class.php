...
class sharedresource_plugin_lom extends sharedresource_plugin_base {
    ...
    */
    ...
    function search(&$fromform, &$result) {
        ...
        if ($fromform->title || $fromform->description) {
            ...
            if ($fromform->search == '*') {
                $resources =  get_records('sharedresource_entry', '', '', $sort);
            } else {
    ...
    */
    function get_metadata(&$sharedresource_entry){
        ...
        $fields = get_records_select('sharedresource_metadata', "entry_id = '$sharedresource_entry->id' AND namespace = 'lom'");
	...
	*/
    function setKeywords($keywords){
    	...
    	delete_records_select('sharedresource_metadata', " namespace = 'lom' AND element LIKE '1_5:0_%' AND entry_id = {$this->entryid} ");
