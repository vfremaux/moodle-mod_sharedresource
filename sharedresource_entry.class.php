...
class sharedresource_entry {
    ...
    static function read_by_id($entry_id) {
        ...
        if (! $sharedresource_entry = get_record('sharedresource_entry', 'id', "$entry_id")) {
            return false;
        }
    ...
    */
    function sharedresource_entry($sharedresource_entry = false) {
        ...
        if (is_object($sharedresource_entry)) {
            ...
            if ($elements = get_records('sharedresource_metadata', 'entry_id', "$this->id")) {
   ...
   /**
    ...
    // of the new instance.
        ...
        if (!$this->url) {
            error("Tried to create a Shared Resource without a URL");
        }
       ...
       // $this->before_save();
        ...
        if (!$id = insert_record('sharedresource_entry', addslashes_object($this))) {
            return false;
        }
        $this->id = $id;
    ...
    // will update an existing instance with new data.
        ...
        if (! delete_records('sharedresource_metadata', 'entry_id', "$this->id")) {
            return false;
        }
	    ...
	    $this->add_element($descriptionelm->name, addslashes($this->description), $CFG->pluginchoice);
        ...
        if (! update_record('sharedresource_entry', addslashes_object($this))) {
            return false;
        }
    ...
    // and any data that depends on it, including local file.
        ...
        if (! delete_records('sharedresource_entry', 'id', $this->id)) {
            return false;
        }
        return true;
    }
